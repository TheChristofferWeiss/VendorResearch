"""
Improved Vendor Scraper - Better link detection and content extraction
"""
...
class ImprovedVendorScraper:
    """Improved vendor scraper with better link detection."""
    ...
    def scrape_vendor_site(self, base_url):
        ...
        print("Pages found:", relevant_pages)
    ...
    def _extract_services(self, content):
        ...
        service_keywords = [
            ...
            'koulutus', 'valmennus', 'kurssi', 'oppiminen', 'esiintymistaito',
            'presentaatio', 'puhe', 'myynti', 'johtaminen'
        ]
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python improved_vendor_scraper.py <vendor_url>")
        print("Example: python improved_vendor_scraper.py https://www.ammattipuhuja.fi")
        return
    
    url = sys.argv[1]
    
    scraper = ImprovedVendorScraper()
